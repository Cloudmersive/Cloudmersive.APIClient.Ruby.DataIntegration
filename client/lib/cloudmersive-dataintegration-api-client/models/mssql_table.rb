...
module CloudmersiveDataintegrationApiClient
  ...
  class MssqlTable
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'schemaName')
        self.schema_name = attributes[:'schemaName']
      end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        temp_model = CloudmersiveDataintegrationApiClient.const_get(type).new
